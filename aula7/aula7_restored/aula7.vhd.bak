...
processador : entity work.processador_aula
          port map (CLK => clk , rst => rst ,data_in_bus => dadolidoRAM, data_out_bus => dadoEscritoRAM,dataAddress => enderecoRAM, Instrution_in => dadoROM, ROM_address =>enderecoROM, RD => leituraRAM, WR => EscritaRAM );
...
buffer_3state_KEY0 : entity work.buffer_3_state_1porta
          port map (entrada => KEY(0) , habilita => habilita_KEY0, saida => dadolidoRAM(0));
